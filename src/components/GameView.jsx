...
export default function GameView({ envState, theme, streak, best = 0, season, roomSeen = 0, onRoomSeen, shake, topBar, title, wall, left, right, bottom, drawer, setDrawer, onOpenCalendar }) {
      ...
      <motion.div className="game-shake" animate={shake}>
        ...
        >
          ...
          <RoomExtras scene={scene} extras={extras} best={best} season={season} sparse={narrowArt}
            seenDay={roomSeen} onSeen={onRoomSeen} />
          <AnimatePresence initial={false}>
